...
source('../../R/Guitar2Plot.r')
source('../../R/getNeighborhood.R')
source('../../R/makeGuitarCoordsFromGRangesList.R')
source('../../R/makeGuitarCoordsFromTxDb.R')
source('../../R/multiplot.R')
source('../../R/narrowPeak2GRanges.R')
...
narrowPeak <- "D:/work/guitar2/reference/Guitar2_lin/inst/extdata/m6A_mm10_exomePeak_1000peaks_bed12.bed"
